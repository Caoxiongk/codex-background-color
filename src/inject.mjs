...
(() => {
  ...
  style.textContent = \
    ...
    '#${MARKER}-panel .author-contact { margin: -3px 0 13px; padding: 8px 9px; border: 1px solid rgba(255,255,255,.18); border-radius: 8px; background: rgba(255,255,255,.08); color: rgba(255,255,255,.86); font-size: 12px; line-height: 1.55; }' +
